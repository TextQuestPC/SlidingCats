        ...
        private async Task<bool> LoadResAsync_comboEffPool()
        {
            if (_comboEffPool == null)
            {
                ...
                } else if (Constant.SceneVersion == "3")
                {
                    ...
                    for (var i = 0; i < 10; ++i)
                    {
                        comboEffFrame3[i] = Resources.Load<Sprite>("Images3/Eff/ComboScore/combo_number_" + i);
                    }
        ...
        {            
            ...
            StartCoroutine(Delay.Run(async () =>
            {
                ...
                if (Constant.SceneVersion == "3")
                {
                    ...
                    if (comboNum >= 10)
                    {
                        ManagerAudio.PlaySound("effectPerfect");
                    ...
                    else
                    {
                       // Debug.Log("RANDOM :" + ran);
                        ...
                        {
                            case 0:
                                ManagerAudio.PlaySound("effectGreat");
                                break;
                            case 1:
                                ManagerAudio.PlaySound("effectAmazing");
                                break;
                            case 2:
                                ManagerAudio.PlaySound("effectExcellent");
                                break;
                            case 3:
                                ManagerAudio.PlaySound("effectGood");
                                break;
